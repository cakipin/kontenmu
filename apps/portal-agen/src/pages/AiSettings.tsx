...
export default function AiSettings() {
  ...
  const handleSync = () => {
    ...
    setTimeout(() => {
      ...
      const totalChunks =
        userChunks + schoolChunks + bookChunks + contentChunks + 10; // +10 base chunks for system info
    ...
    <div className="page-shell">
      <div style={{ marginBottom: "24px" }}>
        ...
        <p style={{ margin: 0, fontSize: "0.95rem", color: "#64748b" }}>
          Kelola tampilan, sambutan, dan endpoint API asisten cerdas (SCHMU
          Chat) untuk pengguna
        </p>
      </div>
      ...
      >
          ...
          >
            ...
            >
              <div>
                ...
                <p style={{ margin: 0, fontSize: "0.85rem", color: "#64748b" }}>
                  Tampilkan atau sembunyikan widget chat secara global untuk
                  level sekolah dan siswa.
                </p>
              </div>
              ...
              <button
                ...
                style={{
                  ...
                  height: "28px",
                  borderRadius: "14px",
                  background: formData.isChatWidgetEnabled
                    ? "#10b981"
                    : "#e2e8f0",
                  border: "none",
                  position: "relative",
              ...
              >
                <div
                  style={{
                    ...
                    position: "absolute",
                    top: "2px",
                    left: formData.isChatWidgetEnabled
                      ? "calc(100% - 26px)"
                      : "2px",
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: "0.8rem", color: "#64748b" }}>
                Pilih penyedia layanan AI yang ingin Anda gunakan sebagai otak
                dari Asisten.
              </p>
            </div>
            ...
            {(formData.aiProvider === "gemini" ||
              ...
              >
                ...
                >
                  API Key{" "}
                  {formData.aiProvider === "gemini" ? "(Gemini)" : "(OpenAI)"}
                </label>
                <input
                  type="password"
                  className="input-control"
                ...
                />
                <p style={{ margin: 0, fontSize: "0.8rem", color: "#64748b" }}>
                  Kunci akses API Anda. Disimpan secara lokal di browser.
                </p>
              </div>
            )}
            ...
            >
              ...
              />
              <p style={{ margin: 0, fontSize: "0.8rem", color: "#64748b" }}>
                Nama bot yang akan tampil di atas jendela percakapan.
              </p>
            </div>
            ...
            >
              ...
              <textarea
                ...
                onChange={(e) =>
                  setFormData({ ...formData, aiWelcomeMessage: e.target.value })
                }
              ...
              />
              <p style={{ margin: 0, fontSize: "0.8rem", color: "#64748b" }}>
                Pesan otomatis yang dikirim asisten saat jendela chat pertama
                kali dibuka.
              </p>
            </div>
            ...
            {formData.aiProvider === "custom" && (
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, aiApiEndpoint: e.target.value })
                  }
                  placeholder="https://contoh.com/api/chat"
                  required={formData.aiProvider === "custom"}
                />
                <p style={{ margin: 0, fontSize: "0.8rem", color: "#64748b" }}>
                  URL server AI. Server harus menerima metode POST dengan
                  payload <code>{`{ message, history }`}</code>.
                </p>
              </div>
            )}
            ...
            >
              ...
              />
              <p style={{ margin: 0, fontSize: "0.8rem", color: "#64748b" }}>
                Instruksi dasar yang selalu diingat oleh AI sebelum merespons
                pengguna.
              </p>
            </div>
        ...
        >
          <div>
            ...
            >
              Artikel dan halaman publik akan dipecah menjadi potongan semantik,
              lalu disimpan di Cloudflare Vectorize.
            </p>
          </div>
