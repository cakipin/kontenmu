    ...
    <div style={{
      ...
      <GlassCard style={{ 
        ...
        <div style={{ marginBottom: '32px' }}>
          <h1 style={{ fontSize: '5rem', fontWeight: 900, color: '#38bdf8', margin: 0, lineHeight: 1 }}>404</h1>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: 'white', margin: '16px 0 8px 0' }}>
