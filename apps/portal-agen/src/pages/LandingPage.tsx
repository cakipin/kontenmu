...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    return () => {
      html.style.setProperty('overflow', previous.htmlOverflow, previous.htmlPriority);
      document.body.style.setProperty('overflow', previous.bodyOverflow, previous.bodyPriority);
      if (root) root.style.setProperty('overflow', previous.rootOverflow, previous.rootPriority);
    };
  }, []);
