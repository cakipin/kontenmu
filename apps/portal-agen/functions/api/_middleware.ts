...
const ROUTE_POLICIES: readonly RoutePolicy[] = [
  ...
  { methods: ["POST"], match: exact("/api/track-view"), roles: ACTIVE_ROLES },
  { methods: ["GET"], match: exact("/api/debug-db"), roles: "public" },
  { methods: ["GET"], match: exact("/api/users"), roles: [...ACTIVE_ROLES, "pending"] },
  { methods: ["GET"], match: exact("/api/debug-siswa"), roles: "public" },
  ...
  { methods: ["POST"], match: exact("/api/upload"), roles: ["superadmin", "uploader", "sekolah", "pending"] },
  ...
  { methods: ["POST", "PUT", "DELETE"], match: exact("/api/allocate"), roles: ["superadmin", "sekolah"] },
  { methods: ["GET"], match: exact("/api/allocations"), roles: ["superadmin", "sekolah", "guru", "siswa"] },
];
