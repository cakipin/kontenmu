      ...
      <GlassCard style={{ width: '100%', maxWidth: '400px', padding: '40px' }}>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <label style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <span style={{ fontSize: '0.875rem', fontWeight: 600, color: 'var(--text-secondary)' }}>Username</span>
            <input
              type="text"
              value={username}
          ...
          <label style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <span style={{ fontSize: '0.875rem', fontWeight: 600, color: 'var(--text-secondary)' }}>Password</span>
            <div style={{ position: 'relative' }}>
              <input
                ...
                style={{ ...inputStyle, width: '100%', paddingRight: '44px', boxSizing: 'border-box' }}
              />
              <button
                type="button"
        ...
        <div style={{ display: 'flex', alignItems: 'center', margin: '24px 0', color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
        ...
        >
          {loading ? (
            ...
            <>
              <img src="/muhammadiyah-logo.png" alt="Muhammadiyah ID" style={{ width: '24px', height: '24px', objectFit: 'contain' }} />
