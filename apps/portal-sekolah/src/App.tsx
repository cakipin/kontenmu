...
function AppContent() {
  ...
  const activeNav =
    NAVIGATION.find((nav) => nav.path === location.pathname) || NAVIGATION[0];
      ...
      <main className="admin-main">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <div
                style={{
                  ...
                  height: "36px",
                  background:
                    "linear-gradient(to top right, var(--primary), var(--accent-primary))",
                  color: "white",
                  borderRadius: "50%",
                  display: "flex",
                  alignItems: "center",
        ...
        >
          <Routes>
            ...
            <Route
              path="/inventory"
              element={<Inventory sekolahId={sekolahId} />}
            />
            <Route
              path="/allocation"
              element={<Allocation sekolahId={sekolahId} />}
            />
          </Routes>
        </div>
      </main>
